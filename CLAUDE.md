...
This command **requires** the project directory as an argument via `C:\Users\ayoth\Downloads\elevatecrm\elevatecrm`.

**Example:** `/create-spec generations/my-app`

**Output location:** `C:\Users\ayoth\Downloads\elevatecrm\elevatecrm/prompts/app_spec.txt` and `C:\Users\ayoth\Downloads\elevatecrm\elevatecrm/prompts/initializer_prompt.md`

If `C:\Users\ayoth\Downloads\elevatecrm\elevatecrm` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `C:\Users\ayoth\Downloads\elevatecrm\elevatecrm/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `C:\Users\ayoth\Downloads\elevatecrm\elevatecrm/prompts/app_spec.txt`
...
**Output path:** `C:\Users\ayoth\Downloads\elevatecrm\elevatecrm/prompts/initializer_prompt.md`
...
**Output path:** `C:\Users\ayoth\Downloads\elevatecrm\elevatecrm/prompts/.spec_status.json`
...
> "Your specification files have been created in `C:\Users\ayoth\Downloads\elevatecrm\elevatecrm/prompts/`!
>
> **Files created:**
> - `C:\Users\ayoth\Downloads\elevatecrm\elevatecrm/prompts/app_spec.txt`
> - `C:\Users\ayoth\Downloads\elevatecrm\elevatecrm/prompts/initializer_prompt.md`
>
